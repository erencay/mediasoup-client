...
const logger = new Logger_1.Logger('Chrome49');
const SCTP_NUM_STREAMS = { OS: 1024, MIS: 1024 };
class Chrome49 extends HandlerInterface_1.HandlerInterface {
    constructor() {
        super();
    ...
    async stopReceiving(localId) {
        ...
        await this._pc.setRemoteDescription(offer);
        const answer = await new Promise((resolve, reject) => this._pc.createAnswer(resolve, reject));
